package com.example.QuanLyChiTieu.MainApplication.Adapters;
...
public class CatelogyAdapter extends  RecyclerView.Adapter<CatelogyAdapter.CatelogyViewHolder>{
    private List<CatelogyModel> mCatelogy;
    private IclickCategory iclickCategory;
    public CatelogyAdapter(List<CatelogyModel> mCatelogy,IclickCategory iclickCategory ) {
    ...
    public void onBindViewHolder(@NonNull CatelogyViewHolder holder, int position) {
        CatelogyModel catelogyModel = mCatelogy.get(position);
